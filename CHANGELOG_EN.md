...
- feat: |i18n| Add Vietnamese (`vi`) support and make it the project-wide default language, including Tiếng Việt in the frontend language switcher, Vietnamese Worker API responses when no language is provided, Vietnamese docs home/default locale, Vietnamese Worker API error messages, and Telegram Bot language selection
