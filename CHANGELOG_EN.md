...
- feat: |i18n| Add Vietnamese (`vi`) support, including Tiếng Việt in the frontend language switcher plus Vietnamese Worker API error messages and Telegram Bot language selection
